 ...
 * each must have been generated by different Statements. All statement getStudentCodes methods implicitly close a statement's current ResultSet if an open one exists.
 */
public class StatementImpl implements Statement {
     ...
     * a Statement to getStudentCodes. If the limit is exceeded, a SQLException is
     * thrown.
     * 
     ...
     * Statement's getStudentCodes methods clear its java.sql.SQLWarning chain.
     ...
     * getStudentCodes methods. This name can then be used in SQL positioned
