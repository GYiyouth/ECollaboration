...
<html>
  <head>
    <title>newstudentapplyitem</title>
    ...
    <link href="files/newstudentapplyitem/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newstudentapplyitem/data.js"></script>
...
<form action="">
      ...
      <!-- Unnamed (提交按钮) -->
      <div id="u94" class="ax_提交按钮">
        <input id="u94_input" type="submit" value="申请"/>
      </div>
</form>
    </div>
  </body>
