...
<html>
  <head>
    <title>newstudentmissiondetail</title>
    ...
    <link href="files/newstudentmissiondetail/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newstudentmissiondetail/data.js"></script>
