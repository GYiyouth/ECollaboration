...
<html>
  <head>
    <title>newteachercreateitem</title>
    ...
    <link href="files/newteachercreateitem/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newteachercreateitem/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u1" class="ax_形状">
        <img id="u1_img" class="img " src="images/newlogin/u1.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u3" class="ax_形状">
        <img id="u3_img" class="img " src="images/newlogin/u3.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u7" class="ax_image">
        <img id="u7_img" class="img " src="images/newlogin/u7.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u10" class="ax_形状">
        <img id="u10_img" class="img " src="images/newlogin/u19.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u12" class="ax_水平线">
        ...
        <img id="u12_line" class="img " src="images/newlogin/u21_line.png" alt="u12_line"/>
      </div>
      ...
      <div id="u26" class="ax_形状">
        <img id="u26_img" class="img " src="images/newstudentitem/u28.png"/>
        <!-- Unnamed () -->
...
<form action="">
      <!-- teachernewitem (提交按钮) -->
      <div id="u62" class="ax_提交按钮" data-label="teachernewitem">
        <input id="u62_input" type="submit" value="新建"/>
      </div>

      <!-- name (文本框) -->
      <div id="u63" class="ax_文本框" data-label="name">
        <input id="u63_input" type="text" value="" name="name"/>
      </div>

      <!-- info (文本框) -->
      <div id="u64" class="ax_文本框" data-label="info">
        <input id="u64_input" type="text" value="" name="info"/>
      </div>

      <!-- creatorid (文本框) -->
      <div id="u65" class="ax_文本框" data-label="creatorid">
        <input id="u65_input" type="text" value="" name="creatorid"/>
      </div>

      <!-- teacherid (文本框) -->
      <div id="u66" class="ax_文本框" data-label="teacherid">
        <input id="u66_input" type="text" value="" name="teacherid"/>
      </div>

      <!-- createdate (文本框) -->
      <div id="u67" class="ax_文本框" data-label="createdate">
        <input id="u67_input" type="text" value="" name="createdate"/>
      </div>

      <!-- grade (文本框) -->
      <div id="u68" class="ax_文本框" data-label="grade">
        <input id="u68_input" type="text" value="" name="grade"/>
      </div>

      <!-- keyword (文本框) -->
      <div id="u69" class="ax_文本框" data-label="keyword">
        <input id="u69_input" type="text" value="" name="keyword"/>
      </div>

      <!-- finishdate (文本框) -->
      <div id="u70" class="ax_文本框" data-label="finishdate">
        <input id="u70_input" type="text" value="" name="finishdate"/>
      </div>

      <!-- applybeforedate (文本框) -->
      <div id="u71" class="ax_文本框" data-label="applybeforedate">
        <input id="u71_input" type="text" value="" name="applybeforedate"/>
      </div>

      <!-- survivaldate (文本框) -->
      <div id="u72" class="ax_文本框" data-label="survivaldate">
        <input id="u72_input" type="text" value="" name="survivaldate"/>
      </div>

      <!-- status (文本框) -->
      <div id="u73" class="ax_文本框" data-label="status">
        <input id="u73_input" type="text" value="" name="status"/>
      </div>

      <!-- teamnumber (文本框) -->
      <div id="u74" class="ax_文本框" data-label="teamnumber">
        <input id="u74_input" type="text" value="" name="teamnumber"/>
      </div>

      <!-- teammax (文本框) -->
      <div id="u75" class="ax_文本框" data-label="teammax">
        <input id="u75_input" type="text" value="" name="teammax"/>
      </div>

      <!-- membermax (文本框) -->
      <div id="u76" class="ax_文本框" data-label="membermax">
        <input id="u76_input" type="text" value="" name="membermax"/>
      </div>

      <!-- requirement (文本框) -->
      <div id="u77" class="ax_文本框" data-label="requirement">
        <input id="u77_input" type="text" value="" name="requirement"/>
      </div>

      <!-- gain (文本框) -->
      <div id="u78" class="ax_文本框" data-label="gain">
        <input id="u78_input" type="text" value="" name="gain"/>
      </div>
</form>
    </div>
  </body>
