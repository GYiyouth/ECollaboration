...
<html>
  <head>
    <title>newteachercreatemission</title>
    ...
    <link href="files/newteachercreatemission/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newteachercreatemission/data.js"></script>
...
<form action="">
      <!-- Unnamed (提交按钮) -->
      <div id="u38" class="ax_提交按钮">
        <input id="u38_input" type="submit" value="新建"/>
      </div>

      <!-- title (文本框) -->
      <div id="u39" class="ax_文本框" data-label="title">
        <input id="u39_input" type="text" value="" name="title"/>
      </div>

      <!-- createdate (文本框) -->
      <div id="u40" class="ax_文本框" data-label="createdate">
        <input id="u40_input" type="text" value="" name="createdate"/>
      </div>

      <!-- targetdate (文本框) -->
      <div id="u41" class="ax_文本框" data-label="targetdate">
        <input id="u41_input" type="text" value="" name="targetdate"/>
      </div>

      <!-- content (文本框) -->
      <div id="u42" class="ax_文本框" data-label="content">
        <input id="u42_input" type="text" value="" name="content"/>
      </div>
</form>
    </div>
  </body>
