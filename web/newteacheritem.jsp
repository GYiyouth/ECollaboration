...
<html>
  <head>
    ...
    <link href="files/newteacheritem/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newteacheritem/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u28" class="ax_形状">
        <img id="u28_img" class="img " src="images/newstudentitem/u28.png"/>
        <!-- Unnamed () -->
