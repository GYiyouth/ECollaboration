...
<html>
  <head>
    ...
    <link href="files/newteachermission/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newteachermission/data.js"></script>
