...
<html>
  <head>
    <title>newteachermissiondetail</title>
    ...
    <link href="files/newteachermissiondetail/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/newteachermissiondetail/data.js"></script>
...
<form action="">
      <!-- makesaccess (提交按钮) -->
      <div id="u46" class="ax_提交按钮" data-label="makesaccess">
        <input id="u46_input" type="submit" value="打分"/>
      </div>

      <!-- saccess (文本框) -->
      <div id="u47" class="ax_文本框" data-label="saccess">
        <input id="u47_input" type="text" value="" name="saccess"/>
      </div>
</form>
    </div>
  </body>
